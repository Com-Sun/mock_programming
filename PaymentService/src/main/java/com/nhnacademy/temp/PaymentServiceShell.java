...
public class PaymentServiceShell {
    ...
    public static void main(String[] args) {
        ...
        PaymentServiceShell paymentServiceShell = new PaymentServiceShell(repository);
        Discount discount = paymentServiceShell.getDiscount(10_000, "PAYCO");

        System.out.println(discount);

    }

    public PaymentServiceShell(DiscountPolicyRepository repository) {
